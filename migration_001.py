...
def main():
    ...
    with psycopg.connect(database_url) as conn:
        with conn.cursor() as cur:
            ...
            if column_exists:
                print("A coluna responsible_user_id já existe.")
            else:
                print("Criando coluna responsible_user_id...")
    ...
    print("========================================")
    print()
    print("clients.responsible_user_id está pronto.")
    print("Nenhum cliente existente foi alterado.")
    print()
